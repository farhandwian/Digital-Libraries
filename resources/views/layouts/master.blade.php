        ...
        <div class="scrollbar-inner">
            ...
            <div class="sidenav-header  align-items-center">
                {{-- <a class="navbar-brand" href="javascript:void(0)">
                    <img src="{{ asset('template') }}/img/brand/logo-1.png" class="navbar-brand-img" alt="...">
                </a> --}}
                <a class="" href="javascript:void(0)">
                    <img src="{{ asset('template') }}/img/brand/logo.png" class="" width="150" height="100" alt="...">
                        ...
                        @auth
                            ...
                            @if (Auth::user()->level == 'admin')
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link dropdown-toggle {{ request()->is('buku') ? 'active' : '' }}"
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="{{ route('buku.indexBiblio') }}">Biblio</a>
                                        <a class="dropdown-item" href="{{ route('buku.indexKoleksi') }}">Koleksi</a>
                                    </div>
                                </li>
                            ...
                            @if (Auth::user()->level == 'admin' || Auth::user()->level == 'user')
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->is('transaksi') ? 'active' : '' }}"
                                        ...
                                        <span class="nav-link-text">Sirkulasi</span>
                                    </a>
                                </li>
                                <li class="nav-item">
