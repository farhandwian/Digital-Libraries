            ...
            <div class="card-body">
                <div class="card-text">
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item">Buku : {{ $transaksi->koleksi->biblio->judul }}</li>  
                        @if ($transaksi->buku->gambar)
                        <li class="list-group-item">Gambar : <img src="{{ 'storage/'.  $transaksi->koleksi->biblio->gambar}}" width="80" height="80" ></li> 
                        @endif
                        @if ($transaksi->ket)
