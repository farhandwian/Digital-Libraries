            ...
            <div class="header-body">
                <div class="row">
                    <div class="col-md-6 mt-4 mb-2">
                        <a class="btn btn-secondary btn-rounded" href="{{ route('anggota.create') }}"> Tambah Anggota</a>
                    </div>
                    <div class="col-md-6 mt-4 mb-3 d-flex justify-content-end">
                        ...
                        <form action="{{ route('anggota.search') }}" method="get"
                            ...
                            <input type="text" placeholder="masukkan pencarian" class="form-control bg-white" name="q"
                                id="q">
                                                ...
                                                <td class="text-right">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                            ...
                                                            <form action="{{ route('anggota.edit', $item->id) }}">
                                    ...
                                    @if ($anggota->lastPage() != 1)
                                        <ul class="pagination justify-content-end mb-0">
                                            ...
                                            @for ($i = 1; $i <= $anggota->lastPage(); $i++)
                                                <li
                                                    class="page-item {{ $i == $anggota->currentPage() ? 'active' : '' }}">
                                                    <a class="page-link"
