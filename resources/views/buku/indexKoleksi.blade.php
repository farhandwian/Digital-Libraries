                                        ...
                                        <div class="modal-content  mt-5">
                                            ...
                                            <div class="modal-body">
                                                <div class="card mb-3">
                                                    <div class="row g-0">
                                                        <div class="col-md-4">
                                                            @if ($item->biblio->gambar)
                                                                <img width="150" height="150"
                                                                    @if ($item->biblio->gambar) src="{{ asset('storage/' . $item->biblio->gambar) }}" @endif />
                                                            @endif
                                                        </div>
                                                        <div class="col-md-8">
                                                            <div class="card-body">
                                                                <div class="card-text">
                                                                    <ul class="list-group list-group-flush">
                                                                        <li class="list-group-item"> {{ $item->biblio->judul }}
                                                                        </li>
                                                                ...
                                                                <div class="card-text text-right"><small
                                                                        class="text-muted">{{ $item->biblio->penulis }}</small>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
